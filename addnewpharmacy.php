...
$pharmacy_name = test_input($_POST["pharmacy_name"]) ?? '';
$pharmacy_street = test_input($_POST["pharmacy_street"]) ?? '';
$pharmacy_city = test_input($_POST["pharmacy_city"]) ?? '';
$pharmacy_state = test_input($_POST["pharmacy_state"]) ?? '';
$pharmacy_zip = test_input($_POST["pharmacy_zip"]) ?? '';
$pharmacy_phone = test_input($_POST["pharmacy_phone"]) ?? '';
$pharmacy_email = test_input($_POST["pharmacy_email"]) ?? '';
